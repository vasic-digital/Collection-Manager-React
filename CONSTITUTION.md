# CONSTITUTION — Collection-Manager-React

Project-specific governance for the **Collection-Manager-React** repository. This document carries the Universal Mandatory Constraints inherited from the cross-project root.
